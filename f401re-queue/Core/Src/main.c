...
int main(void)
{
  ...
  /* add threads, ... */
  xTaskCreate(recvTask, "Receive task", 128, NULL, osPriorityNormal, &handle_task_receiv);

  xTaskCreate(sendingTask, "Send task", 128, NULL, osPriorityNormal, &handle_task_send);
