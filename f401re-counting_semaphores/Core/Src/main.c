...
int main(void)
{
  ...
  handle_count_semap_1 == NULL;
  handle_count_semap_1 = xSemaphoreCreateCounting(1, 1);
  ...
  status = xTaskCreate(button_task_read_entry, "Button task", 128, (void *)&button, osPriorityNormal, &handle_task_button);
